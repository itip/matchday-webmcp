...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { property: 'og:url', content: 'https://matchday-football.iantipton.chatgpt.site' },
      { property: 'og:image', content: 'https://matchday-football.iantipton.chatgpt.site/og.png' },
      ...
      { name: 'twitter:image', content: 'https://matchday-football.iantipton.chatgpt.site/og.png' },
    ],
