...
export const Route = createFileRoute('/')({
  validateSearch: (search: Record<string, unknown>): ScoresSearch => ({ date: isIsoDate(search.date) ? search.date : currentUkIsoDate(), team: typeof search.team === 'string' && search.team ? search.team : undefined, status: search.status === 'live' || search.status === 'upcoming' ? search.status : 'all', countries: typeof search.countries === 'string' && search.countries ? search.countries : undefined, competitions: typeof search.competitions === 'string' && search.competitions ? search.competitions : undefined }),
